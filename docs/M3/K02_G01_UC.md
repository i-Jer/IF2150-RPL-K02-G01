...
<br>
<p align="center">
<img src="./assets/diagram/Diagram Use Case.png" width= "60%" height="60%">
</p>
<br>
...
**Nama Use Case:** *Memperbarui Skor dan Leaderboard*

**Skenario Normal**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Verifikator memverifikasi dan menyetujui klaim pembersihan* | *Sistem menghitung penambahan skor kontribusi untuk Relawan tersebut* |
| 2 | *Verifikator mengonfirmasi pembaruan* | *Sistem menghitung ulang total skor dan memperbarui urutan leaderboard secara real-time* |

<br>

**Skenario Alternatif 1: Pembaruan Poin Gagal**

| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Verifikator memverifikasi dan menyetujui klaim pembersihan* | *Sistem gagal memperbarui leaderboard karena pemrosesan timeout* |
| 2 | *Verifikator mengonfimasi dan menekan kalkulasi ulang* | *Sistem mengulang kalkulasi poin dan memperbarui leaderboard secara otomatis* |

...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Verifikator memverifikasi dan menyetujui klaim pembersihan* | *Sistem gagal memperbarui leaderboard karena pemrosesan timeout, menampilkan pesan "Gagal memperbarui poin", dan meminta pengiriman ulang* |
| 2 | *Verifikator mengirimkan ulang verifikasi* | *Sistem mengulang kalkulasi poin dan memperbarui leaderboard secara otomatis* |

...
| :--- | :--- | :--- | :--- |
| *C01* | *LaporanPencemaran* | *Menyimpan data laporan pencemaran seperti informasi pencemaran, lokasi, dan waktu laporan.* | *UC01, UC02, UC03* |
| *C02* | *BuktiLaporan* | *Menyimpan bukti laporan pencemaran untuk proses verifikasi* | *UC01, UC03* |
| *C03* | *KlaimTitikPencemaran* | *Menyimpan informasi dan lokasi klaim relawan pada titik pencemaran yang akan dibersihkan* | *UC04* |
| *C04* | *LaporanPembersihan* | *Menyimpan data hasil pembersihan yang dilakukan oleh relawan pada titik pencemaran yang telah diklaim* | *UC05, UC06* |
| *C05* | *BuktiPemberishan* | *Menyimpan bukti foto sebelum dan sesudah pembersihan untuk proses verifikasi* | *UC05, UC06* |
| *C06* | *LogVerifikasi* | *Menyimpan hasil verifikasi seperti identitas verifikator, keputusan, dan waktu verifikasi* | *UC03, UC06* |
| *C07* | *Leaderboard* | *Menyimpan dan menampilkan skor kontribusi dan peringkat relawan* | *UC07* |
| *C08* | *AkunRelawan* | *Menyimpan data akun dan informasi relawan* | *UC08* |

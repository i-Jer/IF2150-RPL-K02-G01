...
| *UC07* | *Melihat Leaderboard* | *Relawan dapat melihat leaderboard beserta skornya berdasarkan hasil pem. Pastikan hubungan antarkelas menggunakan jenis relasi yang sesuai (asosiasi, agregasi, komposisi, generalisasi, atau dependensi).
...
| *C09* | *AkunRelawan* | *idRelawan, nama, email* | *kirimLaporanPencemaran()* |


| ID Kelas | Nama Kelas | Deskripsi Kelas | ID Use Case |
| :--- | :--- | :--- | :--- |
| *C01* | *LaporanPencemaran* | *Menyimpan data laporan pencemaran seperti deskripsi, lokasi geospasial, tingkat pencemaran, dan status verifikasi.* | *UC01, UC02, UC03, UC04* |
| *C02* | *BuktiLaporan* | *Menyimpan berkas foto bukti pencemaran beserta metadata EXIF untuk proses validasi.* | *UC01, UC03* |
| *C03* | *KlasterHeatmap* | *Mengagregasi data laporan terverifikasi berdasarkan koordinat untuk menghitung intensitas polusi (heat intensity) dan mendukung filter kategori.* | *UC02* |
| *C04* | *KlaimTitikPencemaran* | *Menyimpan data penguncian (lock) lokasi pencemaran oleh relawan yang berkomitmen melakukan pembersihan.* | *UC04, UC05* |
| *C05* | *LaporanPembersihan* | *Menyimpan data hasil kegiatan pembersihan yang dilakukan relawan pada titik yang diklaim.* | *UC05, UC06* |
| *C06* | *BuktiPembersihan* | *Menyimpan foto sebelum (before) dan sesudah (after) pembersihan serta memvalidasi lokasi geofencing.* | *UC05, UC06* |
| *C07* | *LogVerifikasi* | *Mencatat rekam jejak (audit log) setiap tindakan verifikasi yang dilakukan oleh Verifikator/Admin.* | *UC03, UC06* |
| *C08* | *Leaderboard* | *Mengelola dan menampilkan akumulasi poin kontribusi serta urutan peringkat pengguna.* | *UC06, UC07* |
| *C09* | *AkunRelawan* | *Menyimpan data profil relawan, poin kontribusi, serta status hak akses akun.* | *UC01, UC04, UC07, UC08* |
| *C10* | *Komunitas* | *Menyimpan dan mengelola data organisasi/komunitas lingkungan.* | *UC08* |
| *C11* | *Notifikasi* | *Mengelola dan mengirimkan pemberitahuan real-time mengenai pembaruan status laporan kepada relawan.* | *UC03, UC06* |
l pada relawan yang klaimnya tidak diproses* |
...
| *C09* | *AkunRelawan* | *Profil relawan yang membuat dan mengirimkan laporan.* |
...
| *C03* | *KlasterHeatmap* | *Mengagregasi data lokasi untuk kalkulasi heat intensity dan pemfilteran kategori.* |
...
| *C03* | *KlasterHeatmap* | *idKlaster, koordinatPusat, heatIntensity, kategoriKualitas* | *hitungHeatIntensity(), filterBerdasarkanKategori(), tampilkanHeatmap()* |
...
| *C07* | *LogVerifikasi* | *Mencatat histori tindakan peninjauan dan keputusan verifikator.* |
| *C11* | *Notifikasi* | *Mengirimkan pemberitahuan perubahan status laporan ke relawan.* |
...
| *C07* | *LogVerifikasi* | *idLog, idVerifikator, statusKeputusan, timestamp* | *catatLogVerifikasi()* |
| *C11* | *Notifikasi* | *idNotifikasi, idPenerima, pesan, statusKirim* | *kirimNotifikasiRealtime()* |
...
| *C04* | *KlaimTitikPencemaran* | *Objek transaksi penguncian titik lokasi untuk mencegah klaim ganda.* |
| *C09* | *AkunRelawan* | *Relawan yang melakukan pengklaiman titik.* |
...
| *C04* | *KlaimTitikPencemaran* | *idKlaim, wktKlaim, statusKlaim* | *kunciTitikLokasi(), batalkanKlaim()* |
| *C09* | *AkunRelawan* | *idRelawan, nama* | *ajukanKlaimTitik()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C04* | *KlaimTitikPencemaran* | *Data titik klaim aktif yang menjadi acuan lokasi pembersihan.* |
| *C05* | *LaporanPembersihan* | *Menyimpan data laporan hasil pembersihan yang dibuat relawan.* |
| *C06* | *BuktiPembersihan* | *Menyimpan foto before-after dan memvalidasi radius geofencing.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C04* | *KlaimTitikPencemaran* | *idKlaim, koordinatTitik* | *getKoordinatAcuan()* |
| *C05* | *LaporanPembersihan* | *idPembersihan, deskripsiKegiatan, tglSelesai, statusPembersihan* | *buatLaporanPembersihan(), simpanLaporanPembersihan()* |
| *C06* | *BuktiPembersihan* | *idBuktiPembersihan, fotoBeforeUrl, fotoAfterUrl, gpsBefore, gpsAfter* | *validasiGeofencingRadius()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C05* | *LaporanPembersihan* | *Laporan hasil pembersihan yang ditinjau ulang oleh verifikator.* |
| *C06* | *BuktiPembersihan* | *Foto before-after yang diperiksa secara berdampingan.* |
| *C07* | *LogVerifikasi* | *Mencatat log audit verifikasi hasil pembersihan.* |
| *C08* | *Leaderboard* | *Menerima pembaruan skor pengguna setelah pembersihan disetujui.* |
| *C09* | *AkunRelawan* | *Akun relawan yang skor poinnya bertambah setelah pembersihan valid.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C05* | *LaporanPembersihan* | *idPembersihan, statusPembersihan* | *setHasilVerifikasi()* |
| *C06* | *BuktiPembersihan* | *idBuktiPembersihan, fotoBeforeUrl, fotoAfterUrl* | *tampilkanPerbandinganFoto()* |
| *C07* | *LogVerifikasi* | *idLog, idVerifikator, statusKeputusan, timestamp* | *catatLogAudit()* |
| *C08* | *Leaderboard* | *idLeaderboard* | *hitungUlangPeringkat()* |
| *C09* | *AkunRelawan* | *idRelawan, totalPoin* | *tambahSkorPoin()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C08* | *Leaderboard* | *Mengelola urutan peringkat seluruh relawan berdasarkan poin.* |
| *C09* | *AkunRelawan* | *Data relawan beserta poin kontribusinya.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C08* | *Leaderboard* | *idLeaderboard, daftarPeringkat, tglPembaruan* | *getDaftarPeringkat(), getPosisiPengguna()* |
| *C09* | *AkunRelawan* | *idRelawan, nama, totalPoin* | *getAtributPoin()* |
...
| ID Kelas | Nama Kelas | Deskripsi Kelas |
| :--- | :--- | :--- |
| *C09* | *AkunRelawan* | *Data akun pengguna/relawan yang dapat dikelola oleh Admin.* |
| *C10* | *Komunitas* | *Data organisasi/komunitas yang diperbarui oleh Admin.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C09* | *AkunRelawan* | *idRelawan, nama, email, peran, statusAkun* | *ubahHakAkses(), tangguhkanAkun()* |
| *C10* | *Komunitas* | *idKomunitas, namaKomunitas, deskripsiKomunitas* | *simpanDataKomunitas(), perbaruiKomunitas()* |
